...
def write_results_dict(file_name, results_dict, data_type, num_classes=20):
    if dir(file_name):
        mkdir_if_missing(os.path.dirname(file_name))
...
def eval_imgs_output_dets(opt,
    ...
    #print("results_f_name: ", result_f_name)
...
def main(opt,
    ...
    for seq in seqs:
        ...
        nf, ta, tc = eval_seq(opt, dataloader, data_type, result_filename,
                              save_dir=output_dir, show_image=show_image, frame_rate=60)
        n_frame += nf
...
if __name__ == '__main__':
    ...
    if opt.test_hoot:
        ...
        deer/002
        '''
        data_root = os.path.join(opt.data_dir, 'hoot/images/test')
        print("opt.data_dir: ", opt.data_dir)
        print("data_root: ", data_root)
        #/home/abdulbhutta/Desktop/MCMOT-master/dataset/hoot/images/train/apple
